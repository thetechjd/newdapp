...
export default function Footer() {
  return (
    <footer className='py-6 h-28 md:px-8 px-5 pt-5 pb-3 bg-pattern flex items-center justify-between'>
      <p className='text-xs'>© 2022 - Ascendant LLC</p>
      <div>
        <ul className='flex items-center justify-center space-x-2 md:space-x-4'>
          ...
          <li className=''>
            <a className='bg-opacity-20 items-center relative h-7 tracking-wider pt-0.5 first::pt-0 uppercase text-2xs font-500 padding-huge  duration-200 px-4 flex justify-center flex-row transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110' href='https://ascendant.finance/' target='_blank' rel='noreferrer'>
              <img src='/images/ascendantlogo_white.png' className="w-[100px]" />
            </a>
